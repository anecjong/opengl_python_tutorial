...
def main():
    ...
    fragment_shader_green = shaders.compileShader(fragment_shader_source_green, gl.GL_FRAGMENT_SHADER)
    fragment_shader_yellow = shaders.compileShader(fragment_shader_source_yellow, gl.GL_FRAGMENT_SHADER)

    shader_green = shaders.compileProgram(vertex_shader, fragment_shader_green)
    shader_yellow = shaders.compileProgram(vertex_shader, fragment_shader_yellow)
    gl.glDeleteShader(vertex_shader)
    gl.glDeleteShader(fragment_shader_green)
    gl.glDeleteShader(fragment_shader_yellow)
    ...
    position = gl.glGetAttribLocation(shader_green, "position")
    ...
    while not glfw.window_should_close(window):
        ...
        gl.glUseProgram(shader_green)
        gl.glClear(gl.GL_COLOR_BUFFER_BIT)
        gl.glBindVertexArray(vao_1)
        gl.glDrawArrays(gl.GL_TRIANGLES, 0, 3)

        gl.glUseProgram(shader_yellow)
        gl.glBindVertexArray(vao_2)
        gl.glDrawArrays(gl.GL_TRIANGLES, 0, 3)
