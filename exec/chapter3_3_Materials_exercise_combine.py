...
def main():
    ...
    process_unit.camera.change_camera_pos(glm.vec3(0.0, 0.0, 7.0))
    ...
    while not glfw.window_should_close(window):
        ...
        theta = glfw.get_time()
        radius = 1.0
        light_pos = glm.vec3(radius * sin(theta), radius * cos(theta), 2.0)
        ...
        # material
        container_shader.uniform_vec3("material.ambient", glm.vec3(0.0215, 0.1745, 0.0215))
        container_shader.uniform_vec3("material.diffuse", glm.vec3(0.07568, 0.61424, 0.07568))
        container_shader.uniform_vec3("material.specular", glm.vec3(0.633, 0.727811, 0.633))
        container_shader.uniform_float("material.shininess", 0.6 * 128.0)
        ...
        # material
        container_shader.uniform_vec3("material.ambient", glm.vec3(0.25,	0.20725,	0.20725))
        container_shader.uniform_vec3("material.diffuse", glm.vec3(1,	0.829,	0.829))
        container_shader.uniform_vec3("material.specular", glm.vec3(0.296648,	0.296648,	0.296648))
        container_shader.uniform_float("material.shininess", 0.088 * 128.0)
        ...
        # material
        container_shader.uniform_vec3("material.ambient", glm.vec3(0.1,	0.18725,	0.1745))
        container_shader.uniform_vec3("material.diffuse", glm.vec3(0.396,	0.74151,	0.69102))
        container_shader.uniform_vec3("material.specular", glm.vec3(0.297254,	0.30829,	0.306678))
        container_shader.uniform_float("material.shininess", 0.1 * 128.0)
        gl.glBindVertexArray(container_vao)
        gl.glDrawArrays(gl.GL_TRIANGLES, 0, int(vertices.size / 3))
