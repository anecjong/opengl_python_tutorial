...
import os
import sys
from utils import Shader, Camera, ProcessUnit
...
uniform mat4 projection; void main() {
    ...
    result = vec4((ambient+diffuse+specular) * object_color, 1.0f);
}
"""
...
def main():
    ...
    while not glfw.window_should_close(window):
        ...
        theta = glfw.get_time()
        radius = 2
        light_pos = radius * glm.vec3(0.4, 0, 0.4)
        ...
        model = glm.mat4(1.0)
        model = glm.rotate(model, glm.radians(20), (0, 1, 0))
