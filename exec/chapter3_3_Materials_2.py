...
def main():
    ...
    while not glfw.window_should_close(window):
        ...
        # light
        lamp_color = 0.5 + 0.5 * glm.vec3(sin(glfw.get_time()) * 2.0, sin(glfw.get_time()) * 0.5, cos(glfw.get_time()) * 1.3)
        container_shader.uniform_vec3("light.ambient", glm.vec3(0.2) * lamp_color)
        container_shader.uniform_vec3("light.diffuse", glm.vec3(0.5) * lamp_color)
